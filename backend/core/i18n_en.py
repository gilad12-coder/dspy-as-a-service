...
ENGLISH_MESSAGES: dict[str, str] = {
    ...
    "billing.insufficient_credits": "Your balance is empty. Add credits or start Premium to run on managed compute.",
    ...
    "dataset.share.member_not_found": "No member grant for '{username}' on this dataset.",
    "dataset.share.not_found": "Shared dataset not found or the link was revoked.",
