...
const SETTINGS_ITEMS: Array<
  Pick<SearchItem, "id" | "label" | "keywords" | "icon" | "settingsTab">
> = [
  {
    id: "settings-wizard",
    label: "settings.tab.wizard",
    keywords: ["optimization", "models", "אופטימיזציה", "מודלים"],
    icon: Sparkle,
    settingsTab: "wizard",
  },
  {
    ...
    keywords: ["labels", "copilot", "autopilot", "תיוג", "תוויות"],
    icon: Tag,
    settingsTab: "tagging",
  },
  {
    ...
    keywords: ["assistant", "trust", "memory", "סוכן", "פאנל"],
    icon: Robot,
    settingsTab: "agent",
  },
  {
  ...
  },
  {
    ...
    keywords: ["login", "passkey", "two factor", "אבטחה", "סיסמה", "כניסה", "מפתח גישה"],
    icon: GearSix,
  ...
  },
  {
    ...
    keywords: ["data", "analytics", "cache", "פרטיות", "נתונים"],
    icon: GearSix,
    settingsTab: "privacy",
  },
  {
    ...
    keywords: ["credits", "plan", "payment", "חיוב", "קרדיטים", "תשלום"],
    icon: GearSix,
    settingsTab: "billing",
  },
  {
    ...
    keywords: ["spend", "cost", "tokens", "שימוש", "עלות", "טוקנים"],
    icon: ChartBar,
    settingsTab: "usage",
  },
  {
    ...
    keywords: ["keys", "openai", "anthropic", "ספקים", "מפתחות", "מפתח"],
    icon: GearSix,
  ...
  },
  {
    ...
    keywords: ["token", "developer", "integration", "אסימון", "טוקן", "מפתח api"],
    icon: GearSix,
    settingsTab: "api",
  },
  {
    ...
    keywords: ["version", "defaults", "אודות", "גרסה"],
    icon: GearSix,
    settingsTab: "about",
  },
];
  ...
  const items = React.useMemo<SearchItem[]>(() => {
    ...
    const navigation: SearchItem[] = [
      ...
      },
      {
        ...
        keywords: ["datasets", "labeling", "sessions"],
        icon: Database,
        href: "/datasets",
      },
      {
